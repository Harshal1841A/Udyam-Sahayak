...
This is the frontend component of **Udyam Sahayak**, an offline-first Progressive Web App (PWA) designed for field officers to assess rural SHGs/FPOs/micro-enterprises.
